...
export default function Generator(props) {
  ...
  const {poison, setPoison, muscles, setMuscle, goal, setGoal, updateWorkout } = props
  ...
  return (
    <>
      <SectionWrapper id={'generate'} header={"Generate your music"} title={['It\'s', 'Jam', 'o\'clock']}>
          <Header index={'01'} title={'Pick your favorite'} description={'Select the workout you wish to enjoy'} />
          ...
          <Header index={'02'} title={'Lock on targets'} description={'Select the muscles to use for your vibe sesh'} />
          <div className="bg-slate-950 py-3 border border-solid border-blue-400 rounded-lg flex flex-col">
            ...
            {showModal && (
              <div className=" flex flex-col px-3 pb-3 bg-slate-950 border border-solid border-blue-400 rounded-lg p-3">
          ...
          <Header index={'03'} title={'Become ripped'} description={'Select the your ultimate dance battle.'} />
