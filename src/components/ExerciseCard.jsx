...
export default function ExerciseCard(props) {
  ...
  return (
    <div
      className="p-4 rounded-md flex flex-col bg-slate-950 gap-4 
    sm:flex-wrap"
    >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2 ">
        {["reps", "rest", "tempo"].map((info) => {
          return (
            <div
              key={info}
              className="flex flex-col p-2 rounded border-[2.5px] border-solid border-slate-900 w-full hover:border-[6.5px] duration-200 "
            >
        ...
        <button
          ...
          className="flex flex-col p-2 rounded border-[1.5px] duration-200 border-solid border-green-900 hover:border-green-600 hover:border-[6.5px] w-full duration-200"
        >
